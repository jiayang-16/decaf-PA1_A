...
public abstract class Tree {
    ...
    public static final int VARIDENT = ERRONEOUS + 1;
    /**
    ...
    public static final int ARRAYINIT = MOD + 1;
    public static final int ARRAYJOINT = ARRAYINIT + 1;
    ...
    public static final int IFSUBSTMT = SCOPY + 1;
    public static final int GUARDED = IFSUBSTMT + 1;
    public static final int ARRAYCONSTANT = GUARDED + 1;
    public static final int SUBARRAY = ARRAYCONSTANT + 1;
    public static final int DYNAMICQUERY = SUBARRAY + 1;
    public static final int ARRAYCOMP = DYNAMICQUERY + 1;
    public static final int BOUNDVARIABLE = ARRAYCOMP + 1;
    ...
    public static class Guarded extends Tree {
    	public List<Tree> branchs;
    	public Guarded(List<Tree> branchs,Location loc) {
    		super(GUARDED, loc);
    ...
    public static class ArrayConstant extends Expr{
    	...
    	public ArrayConstant(List<Expr> constList,Location loc) {
    ...
    public static class BoundVariable extends Tree {
    	public String ident;
    	public TypeLiteral type;
    	public BoundVariable(String ident,TypeLiteral type,Location loc) {
    ...
    public static class Foreach extends Tree {
    	public BoundVariable bType;
    	public Expr array;
    	public Expr condition;
    	public Tree stmt;
    	public Foreach(BoundVariable bType,Expr array,Expr condition,Tree stmt,Location loc) {
    		super(FOREACH, loc);
    		this.bType = bType;
    		this.array = array;
    		this.condition = condition;
    ...
    public static class SubArray extends Expr{
    	...
    	public SubArray(Expr array,Expr left,Expr right,Location loc) {
    		super(SUBARRAY, loc);
    		this.array = array;
    		this.left = left;
    		this.right = right;
    ...
    public static class DynamicQuery extends Expr{
    	public Expr array;
    	public Expr index;
    	public Expr defaultExpr;
    	public DynamicQuery(Expr array,Expr index,Expr defaultExpr,Location loc) {
    		super(Tree.DYNAMICQUERY, loc);
    		this.array = array;
    		this.index = index;
    ...
    public static class ArrayComp extends Expr {
    	...
    	public ArrayComp(Expr op,String ident,Expr array,Location loc,Expr If) {
    		super(Tree.ARRAYCOMP, loc);
    		this.op = op;
    		this.ident = ident;
    		this.array = array;
    		this.If = If;
    ...
    public static abstract class Visitor {
        ...
        public void visitDynamicQuery(DynamicQuery that) {
        	visitTree(that);
        }
